    ...
    <div class="container">
            <div class="login-wrapper">
                ...
                <div class="form-wrapper">
                    <input type="text" name="phone" placeholder="请输入您的手机号" class="input-item" v-model="phone" >
                     <p>{{phoneMessage}}</p>
                    <input type="password" name="password" placeholder="请输入您的密码" class="input-item" v-model="password">
                    <el-alert title="密码错误" type="error" show-icon v-if="pwdMessage"> </el-alert>
